...
update :: Board -> (Int, Int) -> Cell -> Board         -- Updates the cell on the board with new value
...
makeStartBoard :: MonadRandom m => Int -> m Board       -- Makes an initial board with some random values
